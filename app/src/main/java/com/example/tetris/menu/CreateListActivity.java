...
//                       .fallbackToDestructiveMigration()
        ...
        imageButtonImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (save()) {
                    Toast.makeText(CreateListActivity.this, "保存成功", Toast.LENGTH_SHORT).show();
                    finish();
                }else {
                    Toast.makeText(CreateListActivity.this, "保存失败", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
